...
module InstructionMemory(	// src/main/scala/dtu/InstructionMemory.scala:30:7
  ...
  ChipFoundrySram m (	// src/main/scala/mem/ChipFoundrySram.scala:9:19
    .clock       (clock),
    .reset       (reset),
    .io_wordAddr (_GEN | apbPort_psel ? apbPort_paddr[9:2] : instrPort_addr[8:1]),	// src/main/scala/dtu/InstructionMemory.scala:57:28, :59:18, :60:19, :73:{40,59}, src/main/scala/mem/ChipFoundrySram.scala:42:17, :47:17
    .io_wrData   (apbPort_pwdata),
    .io_rdData   (_m_io_rdData),
    .io_we       (_GEN),	// src/main/scala/dtu/InstructionMemory.scala:73:40
    .io_strb     (apbPort_pstrb)
  );
  assign instrPort_instr = instrPort_instr_REG ? _m_io_rdData[31:16] : _m_io_rdData[15:0];	// src/main/scala/dtu/InstructionMemory.scala:30:7, :67:25, :68:12, :69:11, :70:11, src/main/scala/mem/ChipFoundrySram.scala:9:19
...
module LerosCaravel_ChipFoundrySram(	// src/main/scala/caravel/LerosCaravel.scala:49:7
