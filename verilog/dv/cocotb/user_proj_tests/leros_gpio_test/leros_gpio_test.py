...
async def leros_gpio_test(dut):
    ...
    # leros-cfram gpio[0] is gpio[23]
    # leros-openram gpio[0] is gpio[29]
    # leros-dffram gpio[0] is gpio[11]
    # leros-regmem gpio[0] is gpio[17]
    


    await cocotb.triggers.Timer(100000,'ns') # wait some time for the programs to run
